...
public class NetworkServiceAdapter extends BaseAdapter {
	...
	private class NetworkServiceConnectButtonClickListener implements Button.OnClickListener {
		...
		public void onClick(View view) {
			ChatConversationFragment chatConversationFragment = new ChatConversationFragment(clientPosition,
					clientType);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			networkServiceViewHolder.networkServiceNameTextView = (TextView) view
					.findViewById(R.id.network_service_name_text_view);
			networkServiceViewHolder.networkServiceConnectButton = (Button) view
					.findViewById(R.id.network_service_connect_button);
		...
		case Constants.CONVERSATION_TO_SERVER:
			networkServiceViewHolder.networkServiceConnectButton
					.setText(context.getResources().getString(R.string.connect));
			break;
		case Constants.CONVERSATION_FROM_CLIENT:
			networkServiceViewHolder.networkServiceConnectButton
					.setText(context.getResources().getString(R.string.view));
			break;
		}
		networkServiceViewHolder.networkServiceConnectButton.setOnClickListener(
				new NetworkServiceConnectButtonClickListener(position, networkService.getServiceType()));
